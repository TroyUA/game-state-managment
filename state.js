...
export class StandingLeft extends State {
  ...
  handleInput(input) {
    ...
    else if (input === 'PRESS down') this.player.setState(states.SITING_LEFT)
...
export class StandingRight extends State {
  ...
  handleInput(input) {
    ...
    else if (input === 'PRESS down') this.player.setState(states.SITING_RIGHT)
...
export class SitingLeft extends State {
  ...
  handleInput(input) {
    if (input === 'PRESS right') this.player.setState(states.SITING_RIGHT)
...
export class SitingRight extends State {
  ...
  handleInput(input) {
    if (input === 'PRESS left') this.player.setState(states.SITING_LEFT)
    else if (input === 'RELEASE down')
...
export class RunningLeft extends State {
  ...
  handleInput(input) {
    if (input === 'PRESS right') this.player.setState(states.RUNNING_RIGHT)
      ...
      this.player.setState(states.STANDING_LEFT)
    else if (input === 'PRESS down') this.state.setState(states.SITING_LEFT)
  }
}
...
export class RunningRight extends State {
  ...
  handleInput(input) {
    if (input === 'PRESS left') this.player.setState(states.RUNNING_LEFT)
      ...
      this.player.setState(states.STANDING_RIGHT)
    else if (input === 'PRESS down') this.state.setState(states.SITING_RIGHT)
  }
}
